  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-slate-400 mt-1">View and attempt your pending quizzes and homework.</p>
      </div>
              ...
              assignments.map((assignment) => (
                <TableRow key={assignment.id} className="border-slate-800 hover:bg-slate-800/50 transition-colors">
                  ...
                  <TableCell>
                     ...
                     <Badge className="bg-slate-800 text-slate-400 hover:bg-slate-800">Pending</Badge>
                  </TableCell>
                  <TableCell className="text-right">
                    <Button 
                        size="sm" 
                        className="bg-blue-600 hover:bg-blue-700 text-white"
                        onClick={() => router.push(`/dashboard/student/assignments/${assignment.id}/attempt`)}
                    >
                        Start
                    </Button>
                  </TableCell>
